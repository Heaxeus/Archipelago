...
def create_regions(world: "ClickMageWorld"):
    ...
    if world.options.EnablePortalLocations == EnablePortalLocations.option_true:
        portal_stage_1 = create_region_and_connect(world, "Portal Stage 1", "Island -> Portal Stage 1", menu)
        portal_stage_2 = create_region_and_connect(world, "Portal Stage 2", "Portal Stage 1 -> Portal Stage 2", portal_stage_1)
        portal_stage_3 = create_region_and_connect(world, "Portal Stage 3", "Portal Stage 2 -> Portal Stage 3", portal_stage_2)
        portal_stage_4 = create_region_and_connect(world, "Portal Stage 4", "Portal Stage 3 -> Portal Stage 4", portal_stage_3)
        portal_stage_5 = create_region_and_connect(world, "Portal Stage 5", "Portal Stage 4 -> Portal Stage 5", portal_stage_4)
        portal_stage_6 = create_region_and_connect(world, "Portal Stage 6", "Portal Stage 5 -> Portal Stage 6", portal_stage_5)
        portal_stage_7 = create_region_and_connect(world, "Portal Stage 7", "Portal Stage 6 -> Portal Stage 7", portal_stage_6)
        portal_stage_8 = create_region_and_connect(world, "Portal Stage 8", "Portal Stage 7 -> Portal Stage 8", portal_stage_7)
        portal_stage_9 = create_region_and_connect(world, "Portal Stage 9", "Portal Stage 8 -> Portal Stage 9", portal_stage_8)
        portal_stage_10 = create_region_and_connect(world, "Portal Stage 10", "Portal Stage 9 -> Portal Stage 10", portal_stage_9)
        portal_stage_11 = create_region_and_connect(world, "Portal Stage 11", "Portal Stage 10 -> Portal Stage 11", portal_stage_10)
        portal_stage_12 = create_region_and_connect(world, "Portal Stage 12", "Portal Stage 11 -> Portal Stage 12", portal_stage_11)
        create_region_and_connect(world, "Portal Stage 13", "Portal Stage 12 -> Portal Stage 13", portal_stage_12)
