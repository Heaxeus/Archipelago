...
def create_regions(world: "ClickMageWorld"):
    island = create_region(world, "Island")

    if world.options.EnableBlueprintLocations == EnableBlueprintLocations.option_true:
        create_region_and_connect(world, "Portal Blueprint", "Island -> Portal Blueprint", island)
        create_region_and_connect(world, "Water Well Blueprint", "Island -> Water Well Blueprint", island)
        create_region_and_connect(world, "Smelter Blueprint", "Island -> Smelter Blueprint", island)
        create_region_and_connect(world, "Charcoal Blueprint", "Island -> Charcoal Blueprint", island)
        create_region_and_connect(world, "Saw Blueprint", "Island -> Saw Blueprint", island)
        create_region_and_connect(world, "Storage Blueprint", "Island -> Storage Blueprint", island)
        create_region_and_connect(world, "Forge Blueprint", "Island -> Forge Blueprint", island)
        create_region_and_connect(world, "Phial Blueprint", "Island -> Phial Blueprint", island)
        create_region_and_connect(world, "Steel Blueprint", "Island -> Steel Blueprint", island)
        create_region_and_connect(world, "Copper Blueprint", "Island -> Copper Blueprint", island)
        create_region_and_connect(world, "Alchemy Blueprint", "Island -> Alchemy Blueprint", island)
        create_region_and_connect(world, "Catalyst Blueprint", "Island -> Catalyst Blueprint", island)

    if world.options.EnableUpgradeLocations == EnableUpgradeLocations.option_true:
        click_hardness_1 = create_region_and_connect(world, "Click Hardness 1", "Island -> Click Hardness 1", island)
        ...
        click_power_1 = create_region_and_connect(world, "Click Power 1", "Island -> Click Power 1", island)
        ...
        hand_size_1 = create_region_and_connect(world, "Hand Size 1", "Island -> Hand Size 1", island)
        ...
        auto_click_1 = create_region_and_connect(world, "Auto Click 1", "Island -> Auto Click 1", island)
        ...
        building_storage_1 = create_region_and_connect(world, "Building Storage 1", "Island -> Building Storage 1", island)
        ...
        fuel_storage_1 = create_region_and_connect(world, "Fuel Storage 1", "Island -> Fuel Storage 1", island)
        ...
        create_region_and_connect(world, "Move Fast", "Island -> Move Fast", island)

        beach_upgrade_1 = create_region_and_connect(world, "Beach Upgrade 1", "Island -> Beach Upgrade 1", island)
    ...
    if world.options.EnablePortalLocations == EnablePortalLocations.option_true:
        portal_scene_1 = create_region_and_connect(world, "Portal Stage 1", "Island -> Portal Stage 1", island)
